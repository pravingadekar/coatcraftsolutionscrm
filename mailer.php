...
// confirmations) — sent via the SALES_SMTP_* mailbox, separate from the
// tenant-notification SMTP_* config used by sendmail.php's admin email.
...
function embedTenantLogoHtml(PHPMailer $mail, string $logoFilePath, string $tenantName): string {
